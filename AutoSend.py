...
class Work(BasePage):
    def Lonin(self,name='20201221101037',password='12345678'):
        try:
            ...
            driver.wait(1)
            New_name = driver.locate_element('x,/html/body/div/div/section/header/section/main/ul/li[2]/div[1]/span').text
    ...
    def WriteLog(self,LogPath):
        try:
            ...
            driver.wait(2)
            driver.click('x,/html/body/div/div/section/section/main/div/div[1]/div[2]/div[3]/div/div[2]/div/div/div/div[2]/div/div[1]/button[1]/span')
            # 点击选择
            driver.click('x,/html/body/div/div/section/section/main/div/div[1]/div[2]/div[3]/div/div[2]/div/div/div/div[2]/div/div[2]/div[3]/table/tbody/tr/td[2]/div/div/div/div[1]/span/span/i')
            # 选择对应部门
            driver.click('x,//*[@id="app"]/div/div[1]/div/div[2]/div/div[1]/div[5]/div[2]/table/tbody/tr[1]/td[12]/div/button/span')
            # 输入工时
            driver.input('x,/html/body/div/div/section/section/main/div/div[1]/div[2]/div[3]/div/div[2]/div/div/div/div[2]/div/div[2]/div[3]/table/tbody/tr/td[6]/div/div/input',1)
            # 输入工作内容
            gettxt = GetTxt()
